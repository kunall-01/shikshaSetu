...
class TChating extends StatefulWidget {
  final Map<String, dynamic> contact;
  final String category;

  const TChating({super.key, required this.contact, required this.category});

  @override
  State<TChating> createState() => _TChatingState();
}

class _TChatingState extends State<TChating> {
