...
import 'package:shikshasetutution/portals/admin/main/admincard.dart';
...
class _MainadminState extends State<Mainadmin> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Provider.of<Adminprovider>(context, listen: false)
        ...
        setState(() {
          filteredUsers =
              Provider.of<Adminprovider>(context, listen: false).admins;
  ...
  void filterUsers(String query, String filter) {
    final admins = Provider.of<Adminprovider>(context, listen: false).admins;

    // Step 1: Filter based on search query
    List<dynamic> filteredUsers = admins.where((user) {
      ...
      body: GestureDetector(
        ...
        child: Consumer<Adminprovider>(
          builder: (context, adminprovider, child) {
            final alladmins =
                filteredUsers.isNotEmpty ? filteredUsers : adminprovider.admins;
                ...
                Row(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text("Admin List", style: TextStyle(fontSize: 24)),
                    ),
                    GestureDetector(
                      onTap: () {
                        showLoading(context);
                        ...
                        WidgetsBinding.instance.addPostFrameCallback((_) {
                          Provider.of<Adminprovider>(context, listen: false)
                              ...
                              .then((_) {
                            setState(() {
                              filteredUsers = Provider.of<Adminprovider>(
                                      context,
                                      listen: false)
                                  .admins;
                              onFilterChanged(selectedFilter);
